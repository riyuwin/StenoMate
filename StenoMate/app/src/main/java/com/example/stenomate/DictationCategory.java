...
public class DictationCategory extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dictation_category);
        ...
        FoundationMenu.setOnClickListener(View -> {
            Intent intent = new Intent(DictationCategory.this, DictationList.class);
        ...
        BackIcon.setOnClickListener(v -> {
            Intent intent = new Intent(DictationCategory.this, MainMenu.class);
            startActivity(intent);
        });
    }
